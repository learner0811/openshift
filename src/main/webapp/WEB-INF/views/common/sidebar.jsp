...
<div class="bg-light border-right" id="sidebar-wrapper">
	...
	<div class="list-group list-group-flush">
		...
		<a href="/bookstore/processorder/index" class="list-group-item list-group-item-action bg-light">Process order</a>
		<a href="/bookstore/actionlog/index" class="list-group-item list-group-item-action bg-light">Action log</a>
	</div>
</div>